...
* `Part_1/`: Configuration files and documentation for Redis replication.
* `Part_2/`: Source code for the gaming leaderboard, including `leaderboard.py` and `streamlit_app.py`.
