...
- Submission copy: [Part_1/redis.conf](Part_1/redis.conf)
...
The same command is saved here:

[Part_1/memtier_benchmark_command.txt](Part_1/memtier_benchmark_command.txt)

Throughput and latency output:

[Part_1/memtier_throughput&latency.txt](Part_1/memtier_throughput&latency.txt)
...
![Redis OSS DB size](Part_1/redis-oss_dbsize.png)
...
![Redis Enterprise database configuration](Part_1/redis-enterprise-db.png)
...
![Redis Enterprise replication status](Part_1/redis-enterprise_status.png)
...
|---|---:|---|
| Redis OSS Source | `146172` | ![Redis OSS key count](Part_1/redis-oss_dbsize.png) |
| Redis Enterprise Target | `146172` | ![Redis Enterprise key count](Part_1/redis-enterprise_dbsize.png) |
...
![Connectivity error](Part_1/Connnectivity%20error.png)
...
- Throughput and latency output included.
